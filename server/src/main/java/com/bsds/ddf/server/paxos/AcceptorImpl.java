...
public class AcceptorImpl implements Acceptor {
  ...
  protected Map<String, ProposalID> promisedIDMap = new ConcurrentHashMap<>();
  protected Map<String, ProposalID> acceptedIDMap = new ConcurrentHashMap<>();
  protected Map<String, String> acceptedValueMap = new ConcurrentHashMap<>();
   ...
   */
  @Override
  public void receivePrepare(String key, String fromUID, ProposalID proposalID, String requestUUID) throws NotBoundException, RemoteException {
    Runnable runnable = () -> {
...
//        ServerLogger.log("Acceptor.receivePrepare(): Condition met to fail the thread.");
//        ServerLogger.log("\n!!!!! FAILING THE ACCEPTOR !!!!!!\n");
//        pause();
//        ServerLogger.log("\n!!!!! STARTING THE FAILED THREAD IN ACCEPTOR !!!!!!\n");
//      }

      ProposalID promisedID = promisedIDMap.getOrDefault(key, null);
      ProposalID acceptedID = acceptedIDMap.getOrDefault(key, null);
      String acceptedValue = acceptedValueMap.getOrDefault(key, null);
   ...
   */
  @Override
  public void receiveAcceptRequest(String key, String fromUID, ProposalID proposalID,
...
//      if(shouldPauseThread()){
//        ServerLogger.log("Acceptor.receiveAcceptRequest(): Condition met to fail the thread.");
//        ServerLogger.log("\n!!!!! FAILING THE ACCEPTOR !!!!!!\n");
//        pause();
//      }
      ProposalID promisedID = promisedIDMap.getOrDefault(key, null);
